...
const userLength = Number(parseFloat(prompt('Inserisci il numero di chilometri (km) che dovrai percorrere')).toFixed(2));
const userAge = parseInt(prompt('Inserisci l\'età del passeggero'));
console.log(userLength);
console.log(userAge);

let ticketPrice = Number(parseFloat(userLength * 0.21).toFixed(2));
